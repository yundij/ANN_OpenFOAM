...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxStatic,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxStatic, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxStatic::DriftFluxStatic
(
...
void Foam::dragModels::driftFluxModels::DriftFluxStatic::evolve()
{
