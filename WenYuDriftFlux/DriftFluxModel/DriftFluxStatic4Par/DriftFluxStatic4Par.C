...
namespace Foam
{
  namespace dragModels
  {
    ...
    {
      defineTypeNameAndDebug(DriftFluxStatic4Par,0);
      addToRunTimeSelectionTable(DriftFluxModel, DriftFluxStatic4Par, dictionary);
    }
  }
}
...
Foam::dragModels::driftFluxModels::DriftFluxStatic4Par::DriftFluxStatic4Par
(
...
void Foam::dragModels::driftFluxModels::DriftFluxStatic4Par::evolve()
{
